...
SESSION_ID: process.env.SESSION_ID === undefined ? 'put_your_session' : process.env.SESSION_ID, // Manu-MD&kK1TkBiC#pwl0_3UU0u9mcT2YmE6cJxlbcDQiNHnz88K0Cj27GcA || ඔයාගෙ සෙසන් එක දාන්න...😌❤
TYPE: process.env.TYPE === undefined ? 'button' : process.env.TYPE, // if you need buttons put 'button' if you need nonbutton ( number reply ) put 'button' || බටන් ඕනි නම් 'button' දාන්න number reply ඕනි නම් nonbutton දාන්න...😌❤
PREFIX: process.env.PREFIX || '.' ,
PORT: process.env.PORT === undefined ? "8000" : process.env.PORT,
SUDO: process.env.SUDO === undefined ? '94777489487' : process.env.SUDO,
